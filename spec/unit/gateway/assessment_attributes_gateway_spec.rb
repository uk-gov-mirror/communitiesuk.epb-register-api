describe Gateway::AssessmentAttributesGateway do
  context "when there are no attributes reseed the table and insert test data" do
    ...
    it 'inserts the attribute value into the database' do
      ...
      expect(attribute_values.first["assessment_id"]).to eq("0000-0000-0000-0000-0001")
    ...
    context 'when we insert many attributes for one assessment' do
      before do
        gateway.add_attribute_value("0000-0000-0000-0000-0001", "construction_age_band", "England and Wales: 2007-2011")
        gateway.add_attribute_value("0000-0000-0000-0000-0001", "glazed_type", "test")
      end
      ...
      it 'returns 2 rows for this assessment' do
        expect(assessement_attribute_values.rows.length).to eq(2)
      end
    end

    context 'when we insert the same attribute for many assessments' do
      before do
        gateway.add_attribute_value("0000-0000-0000-0000-0001", "glazed_type", "another test")
        gateway.add_attribute_value("0000-0000-0000-0000-0002", "glazed_type", "test")
      end
